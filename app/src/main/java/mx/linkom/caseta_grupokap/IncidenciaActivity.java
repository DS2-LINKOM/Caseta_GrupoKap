...
public class IncidenciaActivity  extends mx.linkom.caseta_grupokap.Menu{
    ...
    public void imgFoto(){
        ...
        File foto = new File(getApplication().getExternalFilesDir(null),"incidencia1.png");
    ...
    public void imgFoto2(){
        Intent intentCaptura = new Intent(MediaStore.ACTION_IMAGE_CAPTURE);
        intentCaptura.addFlags(intentCaptura.FLAG_GRANT_READ_URI_PERMISSION);
        File foto = new File(getApplication().getExternalFilesDir(null),"incidencia2.png");
    ...
    public void imgFoto3(){
        Intent intentCaptura = new Intent(MediaStore.ACTION_IMAGE_CAPTURE);
        intentCaptura.addFlags(intentCaptura.FLAG_GRANT_READ_URI_PERMISSION);
        File foto = new File(getApplication().getExternalFilesDir(null),"incidencia3.png");
