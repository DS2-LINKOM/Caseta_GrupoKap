...
public class EntregaFolio  extends mx.linkom.caseta_grupokap.Menu {
            ...
            public void onResponse(String response) {
                ...
                if (response.length()>0){
                    try {
                        ...
                        Intent i = new Intent(getApplicationContext(), mx.linkom.caseta_grupokap.EntregaActivity.class);
                        startActivity(i);
                        finish();
