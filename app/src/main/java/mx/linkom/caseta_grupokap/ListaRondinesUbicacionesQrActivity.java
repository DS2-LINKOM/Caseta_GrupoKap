...
public class ListaRondinesUbicacionesQrActivity extends mx.linkom.caseta_grupokap.Menu{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Incidencia.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(getApplicationContext(), mx.linkom.caseta_grupokap.RondinIncidenciasQr.class);
                startActivity(i);
                finish();
            }
        });
    ...
    public void horarios() {
        String URL = "https://2210.kap-adm.mx/plataforma/casetaV2/controlador/grupokap_access/rondines_qr_2.php";
    ...
    public void rondin(final String id_rondin) {
        String URL = "https://2210.kap-adm.mx/plataforma/casetaV2/controlador/grupokap_access/rondines_qr_3.php";
        RequestQueue requestQueue = Volley.newRequestQueue(this);
        StringRequest stringRequest = new StringRequest(Request.Method.POST, URL, new Response.Listener<String>() {
    ...
    public void ubicaciones(final String id_app) {
        String URL = "https://2210.kap-adm.mx/plataforma/casetaV2/controlador/grupokap_access/rondines_qr_4.php";
        RequestQueue requestQueue = Volley.newRequestQueue(this);
        StringRequest stringRequest = new StringRequest(Request.Method.POST, URL, new Response.Listener<String>() {
                ...
                if (entrada != null) {
                    ...
                    gridList.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                        ...
                        public void onItemClick(AdapterView<?> adapterView, View view, int position, long id) {
                            ...
                            Intent i = new Intent(getApplicationContext(), mx.linkom.caseta_grupokap.RondinInfoQrActivity.class);
                            startActivity(i);
