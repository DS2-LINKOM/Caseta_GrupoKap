...
public class PreEntradasMultiplesQrActivity extends mx.linkom.caseta_grupokap.Menu {
    Configuracion Conf;
...
//ALETORIO3
    ...
    public void imgFoto(){
        ...
        File foto = new File(getApplication().getExternalFilesDir(null),"accesosMulti1.png");
    ...
    public void imgFoto2(){
        Intent intentCaptura = new Intent(MediaStore.ACTION_IMAGE_CAPTURE);
        intentCaptura.addFlags(intentCaptura.FLAG_GRANT_READ_URI_PERMISSION);
        File foto = new File(getApplication().getExternalFilesDir(null),"accesosMulti2.png");
    ...
    public void imgFoto3(){
        Intent intentCaptura = new Intent(MediaStore.ACTION_IMAGE_CAPTURE);
        intentCaptura.addFlags(intentCaptura.FLAG_GRANT_READ_URI_PERMISSION);
        File foto = new File(getApplication().getExternalFilesDir(null),"accesosMulti3.png");
