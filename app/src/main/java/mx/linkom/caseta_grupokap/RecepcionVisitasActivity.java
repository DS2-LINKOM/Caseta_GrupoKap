...
public class RecepcionVisitasActivity extends  mx.linkom.caseta_grupokap.Menu{
                    ...
                    gridList.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                        ...
                        public void onItemClick(AdapterView<?> adapterView, View view, int position, long id) {
                            ...
                            try {
                                ...
                                Intent i = new Intent(getApplicationContext(), mx.linkom.caseta_grupokap.VisitasRecepEntradasDetalle.class);
                                startActivity(i);
                                finish();
