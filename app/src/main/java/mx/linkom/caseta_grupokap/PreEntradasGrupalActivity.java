...
public class PreEntradasGrupalActivity extends mx.linkom.caseta_grupokap.Menu {
...
//ALETORIO3
    ...
    public void imgFoto(){
        ...
        File foto = new File(getApplication().getExternalFilesDir(null),"accesosGrupal1.png");
    ...
    public void imgFoto2(){
        Intent intentCaptura = new Intent(MediaStore.ACTION_IMAGE_CAPTURE);
        intentCaptura.addFlags(intentCaptura.FLAG_GRANT_READ_URI_PERMISSION);
        File foto = new File(getApplication().getExternalFilesDir(null),"accesosGrupal2.png");
    ...
    public void imgFoto3(){
        Intent intentCaptura = new Intent(MediaStore.ACTION_IMAGE_CAPTURE);
        intentCaptura.addFlags(intentCaptura.FLAG_GRANT_READ_URI_PERMISSION);
        File foto = new File(getApplication().getExternalFilesDir(null),"accesosGrupal3.png");
    ...
    public void Validacion() {
        ...
        alertDialogBuilder
                ...
                .setNegativeButton("Cancelar", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int id) {
                        dialog.cancel();
                        Intent i = new Intent(getApplicationContext(), mx.linkom.caseta_grupokap.EntradasSalidasActivity.class);
                        startActivity(i);
                        finish();
