...
public class PlacasActivity extends mx.linkom.caseta_grupokap.Menu {
            ...
            public void onResponse(String response) {
                ...
                if (response.length()>0){
                    try {
                        ...
                        Intent i = new Intent(getApplicationContext(), mx.linkom.caseta_grupokap.PlacasInfoActivity.class);
                        startActivity(i);
                        finish();
